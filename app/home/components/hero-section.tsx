...
export const HeroSection = () => {
  ...
  const handleSearch = () => {
    ...
    if (destination.trim()) {
      router.push(
        `/packages?search=${encodeURIComponent(destination)}&type=${encodeURIComponent(travelType)}&duration=${encodeURIComponent(duration)}`,
      )
    } else {
  ...
  return (
    <section
      ...
      style={{ backgroundImage: "url('/placeholder.svg?height=1080&width=1920&text=Ethiopia+Landscape')" }}
    >
